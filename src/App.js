...
import TelaHistorico from "./pages/HistoricPage/TelaHistorico";
  ...
  return ( 
    <Container>
      ...
      <Routes>
        ...
        <Route path="/habitos" element={<TelaHabitos userData={userData}/>}/>
        <Route path="/historico" element={<TelaHistorico userData={userData}/>}/>
      </Routes>
      </BrowserRouter>
    </Container> 
  );
